...
-   **Example (`mcp-config.yaml` snippet):**
    ...
    services:
      - server_id: my-service-all
        # Loads all entities under project_root/ai/graph/entities/
        entities_dir: "entities"
        # ... other config ...
      - server_id: my-service-subset
        # Loads only entities under project_root/ai/graph/entities/thing/
        # and project_root/ai/graph/entities/person/
        entities_dir:
          - "entities/thing"
          - "entities/person"
        # ... other config ...
