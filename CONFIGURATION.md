...
| `config_file`    | Absolute path to the project's `mcp-config.yaml` file on the host machine.  | string | N/A     | Yes      | `config_file: /path/to/your/project/ai/graph/mcp-config.yaml`                |
...
projects:
  magic-candidates:
    root_dir: /Users/user/DEV/magic-apply-candidates
    config_file: /Users/user/DEV/magic-apply-candidates/ai/graph/mcp-config.yaml
    enabled: true
  civ7-mods:
    root_dir: /Users/user/DEV/civ7-modding-tools
    config_file: /Users/user/DEV/civ7-modding-tools/ai/graph/mcp-config.yaml
    enabled: true
```
...
Each project registered in `mcp-projects.yaml` requires an `mcp-config.yaml` file (typically located at `[project_root]/ai/graph/mcp-config.yaml`). This file defines the specific MCP server instance(s) for that project.
...
```yaml
# [project_root]/ai/graph/mcp-config.yaml
services:
